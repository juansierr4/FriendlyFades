...
${frame}`;
  ...
  var at_default = at; // src/common/ast-path.js
  ...
  var AstPath = class {
    ...
    get key() {
      ...
      return (_at_default = at_default(
      /* isOptionalObject*/
      false, stack, siblings === null ? -2 : -4)) != null ? _at_default : null;
    }
    /** @type {number | null} */
  ...
  var ast_path_default = AstPath; // src/document/constants.js
...
Expected it to be ${EXPECTED_TYPE_VALUES}.`;
  ...
  function stripTrailingHardlineFromParts(parts) {
    ...
    /* isOptionalObject*/
    false, parts, -2).type === DOC_TYPE_LINE && at_default(
    /* isOptionalObject*/
    false, parts, -1).type === DOC_TYPE_BREAK_PARENT) {
      parts.length -= 2;
    }
  ...
  var assert_default = assert; // src/utils/skip.js
  ...
  var has_newline_default = hasNewline; // src/utils/is-non-empty-array.js

  function isNonEmptyArray(object) {
    return Array.isArray(object) && object.length > 0;
  }

  var is_non_empty_array_default = isNonEmptyArray; // src/utils/is-object.js
  ...
  var create_get_visitor_keys_function_default = createGetVisitorKeysFunction; // src/main/comments/utils.js
  ...
  function getSortedChildNodes(node, options) {
    ...
    const childNodes = ((_ref = getCommentChildNodes == null ? void 0 : getCommentChildNodes(node, options)) != null ? _ref : [...getChildren(node, {
      getVisitorKeys: create_get_visitor_keys_function_default(printerGetVisitorKeys)
    })]).flatMap(node2 => canAttachComment(node2) ? [node2] : getSortedChildNodes(node2, options));
  ...
  function isOwnLineComment(text, options, decoratedComments, commentIndex) {
    ...
    return has_newline_default(text, start, {
      backwards: true
    });
  }
  ...
  function breakTies(tiesToBreak, options) {
    ...
    for (indexOfFirstLeadingComment = tieCount; indexOfFirstLeadingComment > 0; --indexOfFirstLeadingComment) {
      ...
      if ((_ref2 = (_b = (_a = options.printer).isGap) == null ? void 0 : _b.call(_a, gap, options)) != null ? _ref2 : /^[\s(]*$/.test(gap)) {
  ...
  var ConfigError = class ConfigError extends Error {
    constructor(...args) {
      super(...args);
  ...
  var UndefinedParserError = class UndefinedParserError extends Error {
    constructor(...args) {
      super(...args);
      this.name = "UndefinedParserError";
    }
  ...
  function getSupportInfo({
    ...
    const languages = plugins.flatMap(plugin => {
      var _plugin$languages;

      return (_plugin$languages = plugin.languages) != null ? _plugin$languages : [];
    });
    const options = [];
  ...
  var get_interpreter_default = void 0; // src/utils/infer-parser.js
  ...
  function getLanguageByName(languages, languageName) {
    var _ref3, _languages$find;

    if (!languageName) {
      return;
    }

    return (_ref3 = (_languages$find = languages.find(({
      name
    }) => name.toLowerCase() === languageName)) != null ? _languages$find : languages.find(({
      aliases
    }) => aliases == null ? void 0 : aliases.includes(languageName))) != null ? _ref3 : languages.find(({
      extensions
  ...
  function inferParser(options, fileInfo) {
    var _ref4, _ref5, _getLanguageByName;

    const languages = options.plugins.flatMap(plugin => {
      var _plugin$languages2;

      return (// @ts-expect-error -- Safe
        (_plugin$languages2 = plugin.languages) != null ? _plugin$languages2 : []
      );
    });
    const language = (_ref4 = (_ref5 = (_getLanguageByName = getLanguageByName(languages, fileInfo.language)) != null ? _getLanguageByName : getLanguageByFilename(languages, fileInfo.physicalFile)) != null ? _ref5 : getLanguageByFilename(languages, fileInfo.file)) != null ? _ref4 : getLanguageByInterpreter(languages, fileInfo.physicalFile);
    return language == null ? void 0 : language.parsers[0];
  }

  var infer_parser_default = inferParser; // node_modules/vnopts/lib/descriptors/api.js
  ...
  var commonDeprecatedHandler = (keyOrPair, redirectTo, {
    ...
    const messages = [`${import_chalk.default.yellow(typeof keyOrPair === "string" ? descriptor.key(keyOrPair) : descriptor.pair(keyOrPair))} is deprecated`];
  ...
  var import_chalk2 = __toESM(require_chalk(), 1); // node_modules/vnopts/lib/constants.js


  var VALUE_NOT_EXIST = Symbol.for("vnopts.VALUE_NOT_EXIST");
  var VALUE_UNCHANGED = Symbol.for("vnopts.VALUE_UNCHANGED"); // node_modules/vnopts/lib/handlers/invalid/common.js
  ...
  function getDescription(key, value, expected, descriptor) {
    return [`Invalid ${import_chalk2.default.red(descriptor.key(key))} value.`, `Expected ${import_chalk2.default.blue(expected)},`, `but received ${value === VALUE_NOT_EXIST ? import_chalk2.default.gray("nothing") : import_chalk2.default.red(descriptor.value(value))}.`].join(" ");
  }
  ...
  var import_chalk3 = __toESM(require_chalk(), 1); // node_modules/leven/index.js
  ...
  var levenUnknownHandler = (key, value, {
    descriptor,
    logger,
    schemas
  }) => {
    const messages = [`Ignored unknown option ${import_chalk3.default.yellow(descriptor.pair({
      key,
      value
    }))}.`];
  ...
  var ChoiceSchema = class extends Schema {
    constructor(parameters) {
      super(parameters);
      this._choices = mapFromArray(parameters.choices.map(choice => choice && typeof choice === "object" ? choice : {
        value: choice
      }), "value");
    }
    ...
    expected({
      ...
      const choiceDescriptions = Array.from(this._choices.keys()).map(value => this._choices.get(value)).filter(({
        hidden
      }) => !hidden).map(choiceInfo => choiceInfo.value).sort(comparePrimitive).map(descriptor.value);
  ...
  var defaultDeprecatedHandler = commonDeprecatedHandler; // node_modules/vnopts/lib/normalize.js
  ...
  var Normalizer = class {
    ...
    _applyNormalization(options, newOptions) {
      ...
      const {
        knownKeys,
        unknownKeys
      } = this._partitionOptionKeys(options);
      ...
      for (const key of knownKeys) {
        ...
        const warnDeprecated = ({
          ...
          const deprecatedResult = normalizeDeprecatedResult(schema.deprecated(currentValue, this._utils), value,
          /* doNotNormalizeTrue */
          true);
    ...
    _applyPostprocess(options) {
      ...
      if (postprocessed.override) {
        const {
          knownKeys,
          unknownKeys
        } = this._partitionOptionKeys(postprocessed.override);
  ...
  function normalizeOptions(options, optionInfos, {
    ...
    const unknown = !passThrough ? (key, value, options2) => {
      ...
      return levenUnknownHandler(key, value, { ...options2,
        schemas: schemas2
      });
  ...
  function optionInfoToSchema(optionInfo, {
    ...
    switch (optionInfo.type) {
      ...
      case "choice":
        ...
        parameters.choices = optionInfo.choices.map(choiceInfo => (choiceInfo == null ? void 0 : choiceInfo.redirect) ? { ...choiceInfo,
          redirect: {
            to: {
              key: optionInfo.name,
    ...
    if (isCLI && !optionInfo.array) {
      ...
      /* isOptionalObject*/
      false, value, -1) : value), utils);
    }

    return optionInfo.array ? ArraySchema.create({ ...(isCLI ? {
        preprocess: v => Array.isArray(v) ? v : [v]
      } : {}),
      ...handlers,
      // @ts-expect-error
      valueSchema: SchemaConstructor.create(parameters)
    }) : SchemaConstructor.create({ ...parameters,
      ...handlers
    });
  }

  var normalize_options_default = normalizeOptions; // src/main/parser-and-printer.js
  ...
  function normalizeFormatOptions(options, opts = {}) {
    ...
    const defaults = { ...formatOptionsHiddenDefaults,
  ...
  var normalize_format_options_default = normalizeFormatOptions; // src/main/parse.js
  ...
  function parse(originalText, options) {
    ...
    try {
      ast = parser.parse(text, options, // TODO: remove the third argument in v4
  ...
  function printEmbeddedLanguages(path, genericPrint, options, printAstToDoc2, embeds) {
    ...
    const getVisitorKeys = create_get_visitor_keys_function_default((_embed$getVisitorKeys = embed.getVisitorKeys) != null ? _embed$getVisitorKeys : printerGetVisitorKeys);
  ...
  function textToDoc(text, partialNextOptions, parentOptions, printAstToDoc2) {
    const options = normalize_format_options_default({ ...parentOptions,
      ...partialNextOptions,
  ...
  function createPrintPreCheckFunction(options) {
    ...
    const getVisitorKeys = create_get_visitor_keys_function_default(options.printer.getVisitorKeys);
  ...
  var create_print_pre_check_function_default = createPrintPreCheckFunction; // src/main/print-ignored.js
  ...
  function printAstToDoc(ast, options) {
    ...
    const doc = callPluginPrintFunction(path, options, mainPrint, void 0, embeds);
  ...
  function prepareToPrint(ast, options) {
    var _ast$comments, _ast$tokens;

    const comments = (_ast$comments = ast.comments) != null ? _ast$comments : [];
    options[Symbol.for("comments")] = comments;
    options[Symbol.for("tokens")] = (_ast$tokens = ast.tokens) != null ? _ast$tokens : [];
