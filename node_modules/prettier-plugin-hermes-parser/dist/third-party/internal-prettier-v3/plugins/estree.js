...
(function (factory) {
  ...
  var print_ignored_default = printIgnored; // src/document/constants.js
  ...
  var VALID_OBJECT_DOC_TYPES = /* @__PURE__ */new Set([DOC_TYPE_CURSOR, DOC_TYPE_INDENT, DOC_TYPE_ALIGN, DOC_TYPE_TRIM, DOC_TYPE_GROUP, DOC_TYPE_FILL, DOC_TYPE_IF_BREAK, DOC_TYPE_INDENT_IF_BREAK, DOC_TYPE_LINE_SUFFIX, DOC_TYPE_LINE_SUFFIX_BOUNDARY, DOC_TYPE_LINE, DOC_TYPE_LABEL, DOC_TYPE_BREAK_PARENT]); // src/document/utils/get-doc-type.js
  ...
  var get_doc_type_default = getDocType; // src/document/invalid-doc-error.js
...
Expected it to be ${EXPECTED_TYPE_VALUES}.`;
  ...
  var InvalidDocError = class InvalidDocError extends Error {
    constructor(doc) {
  ...
  var invalid_doc_error_default = InvalidDocError; // src/document/utils/traverse-doc.js
  ...
  var traverse_doc_default = traverseDoc; // src/document/utils/assert-doc.js
  ...
  function group(contents, opts = {}) {
    assertDoc(contents);
    assertDocArray(opts.expandedStates,
    /* optional */
    true);
    return {
      type: DOC_TYPE_GROUP,
  ...
  var at_default = at; // src/document/utils.js
  ...
  function propagateBreaks(doc) {
    ...
    traverse_doc_default(doc, propagateBreaksOnEnterFn, propagateBreaksOnExitFn,
  ...
  function inheritLabel(doc, fn) {
    return doc.type === DOC_TYPE_LABEL ? { ...doc,
  ...
  var is_non_empty_array_default = isNonEmptyArray; // node_modules/@prettier/is-es5-identifier-name/dist/index.js
  ...
  var src_default = isEs5IdentifierName; // src/utils/is-object.js

  function isObject(object) {
    return object !== null && typeof object === "object";
  }

  var is_object_default = isObject; // src/utils/ast-utils.js

  function* getChildren(node, options2) {
    const {
      getVisitorKeys: getVisitorKeys3,
      filter = () => true
    } = options2;
  ...
  var skip_newline_default = skipNewline; // src/utils/has-newline.js

  function hasNewline(text, startIndex, options2 = {}) {
    const idx = skipSpaces(text, options2.backwards ? startIndex - 1 : startIndex, options2);
    const idx2 = skip_newline_default(text, idx, options2);
    return idx !== idx2;
  }

  var has_newline_default = hasNewline; // src/utils/skip-inline-comment.js
  ...
  var skip_inline_comment_default = skipInlineComment; // src/utils/skip-trailing-comment.js
  ...
  var skip_trailing_comment_default = skipTrailingComment; // src/utils/is-next-line-empty.js
  ...
  var is_next_line_empty_default = isNextLineEmpty; // node_modules/emoji-regex/index.mjs
  ...
  var get_string_width_default = getStringWidth; // src/language-js/loc.js
  ...
  function locStart(node) {
    ...
    const decorators = (_ref = (_a = node.declaration) == null ? void 0 : _a.decorators) != null ? _ref : node.decorators;
  ...
  var create_get_visitor_keys_default = createGetVisitorKeys; // src/language-js/traverse/visitor-keys.evaluate.js
  ...
  var get_visitor_keys_default = getVisitorKeys; // src/language-js/utils/create-type-check-function.js
  ...
  var create_type_check_function_default = createTypeCheckFunction; // src/language-js/utils/is-block-comment.js

  var isBlockComment = create_type_check_function_default(["Block", "CommentBlock", // `meriyah`
  "MultiLine"]);
  var is_block_comment_default = isBlockComment; // src/language-js/utils/is-node-matches.js
  ...
  var is_node_matches_default = isNodeMatches; // src/language-js/utils/is-flow-keyword-type.js

  var isFlowKeywordType = create_type_check_function_default(["AnyTypeAnnotation", "ThisTypeAnnotation", "NumberTypeAnnotation", "VoidTypeAnnotation", "BooleanTypeAnnotation", "BigIntTypeAnnotation", "SymbolTypeAnnotation", "StringTypeAnnotation", "NeverTypeAnnotation", "UndefinedTypeAnnotation", "UnknownTypeAnnotation", // FLow only
  "EmptyTypeAnnotation", "MixedTypeAnnotation"]);
  var is_flow_keyword_type_default = isFlowKeywordType; // src/language-js/utils/is-ts-keyword-type.js
  ...
  var is_ts_keyword_type_default = isTsKeywordType; // src/language-js/utils/index.js
  ...
  function getLeftSide(node) {
    ...
    return (_ref2 = (_ref3 = (_ref4 = (_ref5 = (_ref6 = (_node$left = node.left) != null ? _node$left : node.test) != null ? _ref6 : node.callee) != null ? _ref5 : node.object) != null ? _ref4 : node.tag) != null ? _ref3 : node.argument) != null ? _ref2 : node.expression;
  }
  ...
  var isLineComment = create_type_check_function_default(["Line", "CommentLine", // `meriyah` has `SingleLine`, `HashbangComment`, `HTMLOpen`, and `HTMLClose`
  "SingleLine", "HashbangComment", "HTMLOpen", "HTMLClose", // `espree`
  "Hashbang", // Babel hashbang
  "InterpreterDirective"]);
  ...
  var isSimpleTypeAnnotation = create_type_check_function_default(["TSThisType", // literals
  "NullLiteralTypeAnnotation", "BooleanLiteralTypeAnnotation", "StringLiteralTypeAnnotation", "BigIntLiteralTypeAnnotation", "NumberLiteralTypeAnnotation", "TSLiteralType", "TSTemplateLiteralType"]);
  ...
  function needsHardlineAfterDanglingComment(node) {
    ...
    /* isOptionalObject*/
    false, getComments(node, CommentCheckFlags.Dangling), -1);
  ...
  function isSimpleCallArgument(node, depth = 2) {
    ...
    if (isRegExpLiteral(node)) {
      ...
      return get_string_width_default((_node$pattern = node.pattern) != null ? _node$pattern : node.regex.pattern) <= 5;
    }
  ...
  function rawText(node) {
    ...
    return (_ref7 = (_a = node.extra) == null ? void 0 : _a.raw) != null ? _ref7 : node.raw;
  }
  ...
  function hasRestParameter(node) {
    ...
    /* isOptionalObject*/
    false, parameters, -1)) == null ? void 0 : _a.type) === "RestElement";
  }
  ...
  var isBinaryCastExpression = create_type_check_function_default([// TS
  "TSAsExpression", "TSSatisfiesExpression", // Flow
  "AsExpression", "AsConstExpression", "SatisfiesExpression"]); // src/language-js/needs-parens.js
  ...
  function needsParens(path, options2) {
    ...
    if (node.type === "Identifier") {
      ...
      if (node.name === "let") {
        const expression = (_b = path.findAncestor(node2 => node2.type === "ForOfStatement")) == null ? void 0 : _b.left;
      ...
      if (key === "expression") {
        switch (node.name) {
          ...
          case "type":
            {
              const ancestorNeitherAsNorSatisfies = path.findAncestor(node2 => !isBinaryCastExpression(node2));
    ...
    if (node.type === "ObjectExpression" || node.type === "FunctionExpression" || node.type === "ClassExpression" || node.type === "DoExpression") {
      const expression = (_c = path.findAncestor(node2 => node2.type === "ExpressionStatement")) == null ? void 0 : _c.expression;
    ...
    if (node.type === "ObjectExpression") {
      const arrowFunctionBody = (_d = path.findAncestor(node2 => node2.type === "ArrowFunctionExpression")) == null ? void 0 : _d.body;
    ...
    switch (parent.type) {
      ...
      case "TypeAnnotation":
        if (path.match(void 0, void 0, (node2, key2) => key2 === "returnType" && node2.type === "ArrowFunctionExpression") && includesFunctionTypeInObjectType(node)) {
          return true;
        }
    ...
    switch (node.type) {
      ...
      case "TSFunctionType":
        if (path.match(node2 => node2.type === "TSFunctionType", (node2, key2) => key2 === "typeAnnotation" && node2.type === "TSTypeAnnotation", (node2, key2) => key2 === "returnType" && node2.type === "ArrowFunctionExpression")) {
          return true;
        }
      ...
      case "FunctionTypeAnnotation":
        {
          ...
          if (path.match(void 0, (node2, key2) => key2 === "typeAnnotation" && node2.type === "TypeAnnotation", (node2, key2) => key2 === "returnType" && node2.type === "ArrowFunctionExpression")) {
            return true;
          }

          if (path.match(void 0, (node2, key2) => key2 === "typeAnnotation" && node2.type === "TypePredicate", (node2, key2) => key2 === "typeAnnotation" && node2.type === "TypeAnnotation", (node2, key2) => key2 === "returnType" && node2.type === "ArrowFunctionExpression")) {
            return true;
          }
          ...
          parent.type === "FunctionTypeParam" && parent.name === null && getFunctionParameters(node).some(param => {
            var _a2;
  ...
  var isStatement = create_type_check_function_default(["BlockStatement", "BreakStatement", "ComponentDeclaration", "ClassBody", "ClassDeclaration", "ClassMethod", "ClassProperty", "PropertyDefinition", "ClassPrivateProperty", "ContinueStatement", "DebuggerStatement", "DeclareComponent", "DeclareClass", "DeclareExportAllDeclaration", "DeclareExportDeclaration", "DeclareFunction", "DeclareInterface", "DeclareModule", "DeclareModuleExports", "DeclareVariable", "DeclareEnum", "DoWhileStatement", "EnumDeclaration", "ExportAllDeclaration", "ExportDefaultDeclaration", "ExportNamedDeclaration", "ExpressionStatement", "ForInStatement", "ForOfStatement", "ForStatement", "FunctionDeclaration", "IfStatement", "ImportDeclaration", "InterfaceDeclaration", "LabeledStatement", "MethodDefinition", "ReturnStatement", "SwitchStatement", "ThrowStatement", "TryStatement", "TSDeclareFunction", "TSEnumDeclaration", "TSImportEqualsDeclaration", "TSInterfaceDeclaration", "TSModuleDeclaration", "TSNamespaceExportDeclaration", "TypeAlias", "VariableDeclaration", "WhileStatement", "WithStatement"]);
  ...
  function includesFunctionTypeInObjectType(node) {
    return hasNode(node, node2 => node2.type === "ObjectTypeAnnotation" && hasNode(node2, node3 => node3.type === "FunctionTypeAnnotation"));
  }
  ...
  function shouldWrapFunctionForExportDefault(path, options2) {
    ...
    return path.call(() => shouldWrapFunctionForExportDefault(path, options2), ...getLeftSidePathName(node));
  }
  ...
  function shouldAddParenthesesToChainElement(path) {
    ...
    if (path.match(() => node.type === "CallExpression" || node.type === "MemberExpression", (node2, name) => name === "expression" && node2.type === "ChainExpression") && (path.match(void 0, void 0, (node2, name) => name === "callee" && (node2.type === "CallExpression" && !node2.optional || node2.type === "NewExpression") || name === "object" && node2.type === "MemberExpression" && !node2.optional) || path.match(void 0, void 0, (node2, name) => name === "expression" && node2.type === "TSNonNullExpression", (node2, name) => name === "object" && node2.type === "MemberExpression"))) {
      return true;
    }

    if (path.match(() => node.type === "CallExpression" || node.type === "MemberExpression", (node2, name) => name === "expression" && node2.type === "TSNonNullExpression", (node2, name) => name === "expression" && node2.type === "ChainExpression", (node2, name) => name === "object" && node2.type === "MemberExpression")) {
      return true;
    }
  ...
  var needs_parens_default = needsParens; // scripts/build/shims/string-replace-all.js
  ...
  var string_replace_all_default = stringReplaceAll; // src/utils/is-previous-line-empty.js
  ...
  var is_previous_line_empty_default = isPreviousLineEmpty; // src/main/comments/print.js
  ...
  function printLeadingComment(path, options2) {
    ...
    const index = skip_newline_default(originalText, skipSpaces(originalText, locEnd2(comment)));
  ...
  function printTrailingComment(path, options2, previousComment) {
    ...
    if ((previousComment == null ? void 0 : previousComment.hasLineSuffix) && !(previousComment == null ? void 0 : previousComment.isBlock) || has_newline_default(originalText, locStart2(comment), {
      backwards: true
    })) {
      const isLineBeforeEmpty = is_previous_line_empty_default(originalText, locStart2(comment));
      return {
  ...
  function printCommentsSeparately(path, options2) {
    ...
    path.each(() => {
      ...
      if (leading) {
        ...
        printedTrailingComment = printTrailingComment(path, options2, printedTrailingComment);
  ...
  function printComments(path, doc, options2) {
    const {
      leading,
      trailing
    } = printCommentsSeparately(path, options2);
  ...
  var UnexpectedNodeError = class UnexpectedNodeError extends Error {
  ...
  var unexpected_node_error_default = UnexpectedNodeError; // src/utils/get-preferred-quote.js
  ...
  var get_preferred_quote_default = getPreferredQuote; // node_modules/escape-string-regexp/index.js
  ...
  var whitespace_utils_default = WhitespaceUtils; // src/language-js/comments/handle-comments.js
  ...
  var get_next_non_space_non_comment_character_index_default = getNextNonSpaceNonCommentCharacterIndex; // src/utils/get-next-non-space-non-comment-character.js
  ...
  var get_next_non_space_non_comment_character_default = getNextNonSpaceNonCommentCharacter; // src/utils/has-newline-in-range.js
  ...
  var has_newline_in_range_default = hasNewlineInRange; // src/main/comments/utils.js
  ...
  function addCommentHelper(node, comment) {
    ...
    const comments = (_node$comments = node.comments) != null ? _node$comments : node.comments = [];
  ...
  var is_type_cast_comment_default = isTypeCastComment; // src/language-js/comments/handle-comments.js
  ...
  function handleClassComments({
    ...
    if (classLikeNodeTypes.has(enclosingNode == null ? void 0 : enclosingNode.type)) {
      if (is_non_empty_array_default(enclosingNode.decorators) && !((followingNode == null ? void 0 : followingNode.type) === "Decorator")) {
        ...
        /* isOptionalObject*/
        false, enclosingNode.decorators, -1), comment);
        return true;
      }
  ...
  var is_indentable_block_comment_default = isIndentableBlockComment; // src/language-js/print/comment.js
  ...
  function printIndentableBlockComment(comment) {
    const lines = comment.value.split("\n");
    return ["/*", join(hardline, lines.map((line2, index) => index === 0 ? line2.trimEnd() : " " + (index < lines.length - 1 ? line2.trim() : line2.trimStart()))), "*/"];
  } // src/language-js/comments/printer-methods.js


  var nodeTypesCanNotAttachComment = /* @__PURE__ */new Set(["EmptyStatement", "TemplateElement", // In ESTree `import` is a token, `import("foo")`
  "Import", // There is no similar node in Babel AST
  // ```ts
  // class Foo {
  //   bar();
  ...
  // }
  // ```
  "TSEmptyBodyFunctionExpression", // There is no similar node in Babel AST, `a?.b`
  "ChainExpression"]);
    ...
    path.each(({
      ...
      if (node.type === "JSXText") {
        ...
        if (isMeaningfulJsxText(node)) {
          const words = jsxWhitespaceUtils.split(text,
          /* captureWhitespace */
          true);
  ...
  function shouldPrintBracketSameLine(node, options2, nameHasComments) {
    ...
    /* isOptionalObject*/
    false, node.attributes, -1), CommentCheckFlags.Trailing);
    return (// Simple tags (no attributes and no comment in tag name) should be
  ...
  function printJsx(path, options2, print3) {
    ...
    switch (node.type) {
      ...
      case "JSXClosingFragment":
        return printJsxOpeningClosingFragment(path, options2
        /*, print*/
        );

      case "JSXEmptyExpression":
        return printJsxEmptyExpression(path, options2
        /*, print*/
        );
  ...
  var is_ignored_default = isIgnored; // src/language-js/print/binaryish.js
  ...
  function printBinaryishExpression(path, options2, print3) {
    ...
    const parts = printBinaryishExpressions(path, print3, options2,
    /* isNested */
    ...
    const chain = group([// Don't include the initial expression in the indentation
    // level. The first item is guaranteed to be the first
    // left-most expression.
    ...headParts, indent(rest)], {
      id: groupId
    });
  ...
  function printBinaryishExpressions(path, print3, options2, isNested, isInsideParenthesis) {
    ...
    if (shouldFlatten(node.operator, node.left.operator)) {
      parts = path.call(left => printBinaryishExpressions(left, print3, options2,
      /* isNested */
    ...
    if (shouldInline) {
      ...
      const rightContent = isHackPipeline ? path.call(left => printBinaryishExpressions(left, print3, options2,
      /* isNested */
      true, isInsideParenthesis), "right") : print3("right");
  ...
  var ArgExpansionBailout = class ArgExpansionBailout extends Error {
    constructor(...args) {
      super(...args);
  ...
  function printArray(path, options2, print3) {
    ...
    const closeBracket = "]";
    const elementsProperty = // TODO: Remove `types` when babel changes AST of `TupleTypeAnnotation`
  ...
  function printCallArguments(path, options2, print3) {
    ...
    iterateCallArgumentsPath(path, ({
      ...
      if (index === lastArgIndex) {} else if (isNextLineEmpty2(arg, options2)) {
  ...
  var call_arguments_default = printCallArguments; // src/language-js/print/member.js
  ...
  function printMemberExpression(path, options2, print3) {
    ...
    const firstNonMemberParent = path.findAncestor(node2 => !(isMemberExpression(node2) || node2.type === "TSNonNullExpression"));
  ...
  function printMemberChain(path, options2, print3) {
    ...
    function printGroup(printedGroup) {
      ...
      /* isOptionalObject*/
      false, printedGroup, -1).needsParens) {
        return ["(", ...printed, ")"];
      }
    ...
    /* isOptionalObject*/
    false, groups[shouldMerge ? 1 : 0], -1).node;
    ...
    function lastGroupWillBreakAndOtherCallsHaveFunctionArguments() {
      ...
      false, at_default(
      /* isOptionalObject*/
      false, groups, -1), -1).node;
      const lastGroupDoc = at_default(
      /* isOptionalObject*/
      false, printedGroups, -1);
  ...
  var member_chain_default = printMemberChain; // src/language-js/print/call-expression.js
  ...
  function printCallExpression(path, options2, print3) {
    ...
    isTestCall(node, parent))) {
      ...
      if (!(isTemplateLiteralSingleArg && ((_a = printed[0].label) == null ? void 0 : _a.embed))) {
        return [isNew ? "new " : "", print3("callee"), optional, printFunctionTypeParameters(path, options2, print3), "(", join(", ", printed), ")"];
      }
    }
    ...
    const contents = [isNew ? "new " : "", isDynamicImport ? "import" : print3("callee"), optional, printFunctionTypeParameters(path, options2, print3), call_arguments_default(path, options2, print3)];
  ...
  function makeString(rawText2, enclosingQuote, unescapeUnnecessaryEscapes) {
    ...
    /* isOptionalObject*/
    false, rawText2, regex, (match, escaped, quote) => {
  ...
  var make_string_default = makeString; // src/utils/print-string.js
  ...
  function printString(raw, options2) {
    ...
    return make_string_default(rawContent, enclosingQuote, !(options2.parser === "css" || options2.parser === "less" || options2.parser === "scss" || options2.__embeddedInHtml));
  }

  var print_string_default = printString; // src/utils/print-number.js

  function printNumber(rawNumber) {
    return rawNumber.toLowerCase().replace(/^([+-]?[\d.]+e)(?:\+|(-))?0*(?=\d)/, "$1$2").replace(/^([+-]?[\d.]+)e[+-]?0+$/, "$1").replace(/^([+-])?\./, "$10.").replace(/(\.\d+?)0+(?=e|$)/, "$1").replace(/\.(?=e|$)/, "");
  }

  var print_number_default = printNumber; // src/language-js/print/literal.js
  ...
  var isLiteral = create_type_check_function_default(["Literal", // Babel, flow uses `BigIntLiteral` too
  "BigIntLiteral", "BooleanLiteral", "DecimalLiteral", "DirectiveLiteral", "NullLiteral", "NumericLiteral", "RegExpLiteral", "StringLiteral"]); // src/language-js/print/assignment.js
  ...
  function printAssignment(path, options2, print3, leftDoc, operator, rightPropertyName) {
    ...
    const rightDoc = rightPropertyName ? print3(rightPropertyName, {
  ...
  function printAssignmentExpression(path, options2, print3) {
    ...
    return printAssignment(path, options2, print3, print3("left"), [" ", node.operator], "right");
  }
  ...
  function chooseLayout(path, options2, print3, leftDoc, rightPropertyName) {
    ...
    if (path.call(() => shouldBreakAfterOperator(path, options2, print3, hasShortKey), rightPropertyName)) {
      return "break-after-operator";
    }
  ...
  function shouldBreakAfterOperator(path, options2, print3, hasShortKey) {
    ...
    if (isStringLiteral(node) || path.call(() => isPoorlyBreakableMemberOrCallChain(path, options2, print3), ...propertiesForPath)) {
      return true;
    }
  ...
  function isComplexDestructuring(node) {
    if (isAssignmentOrVariableDeclarator(node)) {
      ...
      return leftNode.type === "ObjectPattern" && leftNode.properties.length > 2 && leftNode.properties.some(property => {
        var _a;
  ...
  var isTypeAlias = create_type_check_function_default(["TSTypeAliasDeclaration", "TypeAlias"]);
  ...
  function hasComplexTypeAnnotation(node) {
    ...
    return is_non_empty_array_default(typeParams) && typeParams.length > 1 && typeParams.some(param => is_non_empty_array_default(getTypeParametersFromTypeReference(param)) || param.type === "TSConditionalType");
  }
  ...
  var isTypeReference = create_type_check_function_default(["TSTypeReference", "GenericTypeAnnotation"]);
  ...
  function getTypeArgumentsFromCallExpression(node) {
    ...
    return (_a = (_node$typeParameters = node.typeParameters) != null ? _node$typeParameters : node.typeArguments) == null ? void 0 : _a.params;
  ...
  function printFunctionParameters(path, print3, options2, expandArg, printTypeParams) {
    ...
    if (parameters.length === 0) {
      return [typeParams, "(", printDanglingComments(path, options2, {
    ...
    const hasNotParameterDecorator = parameters.every(node => !is_non_empty_array_default(node.decorators));
    ...
    return [typeParams, "(", indent([softline, ...printed]), ifBreak(!hasRestParameter(functionNode) && shouldPrintComma(options2, "all") ? "," : ""), softline, ")"];
  }
  ...
  function isDecoratedFunction(path) {
    return path.match(node => node.type === "ArrowFunctionExpression" && node.body.type === "BlockStatement", (node, name) => {
  ...
  function shouldHugType(node) {
    ...
    if (node.type === "UnionTypeAnnotation" || node.type === "TSUnionType") {
      ...
      const hasObject = node.types.some(node2 => node2.type === "ObjectTypeAnnotation" || node2.type === "TSTypeLiteral" || // This is a bit aggressive but captures Array<{x}>
  ...
  function printOpaqueType(path, options2, print3) {
    ...
    const parts = [printDeclareToken(path), "opaque type ", print3("id"), print3("typeParameters")];
  ...
  function printTypeAlias(path, options2, print3) {
    ...
    return [printAssignment(path, options2, print3, parts, " =", rightPropertyName), semi];
  }

  function printIntersectionType(path, options2, print3) {
    let wasIndented = false;
    return group(path.map(({
      isFirst,
      previous,
      node,
      index
  ...
  function printUnionType(path, options2, print3) {
    ...
    if (parent.type === "TupleTypeAnnotation" || parent.type === "TSTupleType") {
      const elementTypes = parent[// TODO: Remove `types` when babel changes AST of `TupleTypeAnnotation`
  ...
  function printFunctionType(path, options2, print3) {
    ...
    const parts = [// `TSConstructorType` only
    ...
    let parametersDoc = printFunctionParameters(path, print3, options2,
    /* expandArg */
    false,
    /* printTypeParams */
    true);
    ...
    if (node.type === "FunctionTypeAnnotation") {
      returnTypeDoc.push(isFlowArrowFunctionTypeAnnotation(path) ? " => " : ": ", print3("returnType"));
    } else {
      returnTypeDoc.push(printTypeAnnotationProperty(path, print3, node.returnType ? "returnType" : "typeAnnotation"));
    }
  ...
  function printIndexedAccessType(path, options2, print3) {
    return [print3("objectType"), printOptionalToken(path), "[", print3("indexType"), "]"];
  }
  ...
  function printJSDocType(path, print3, token) {
    ...
    return [node.postfix ? "" : token, printTypeAnnotationProperty(path, print3), node.postfix ? token : ""];
  }
  ...
  function printRestType(path, options2, print3) {
    ...
    return ["...", ...(node.type === "TupleTypeSpreadElement" && node.label ? [print3("label"), ": "] : []), print3("typeAnnotation")];
  }
  ...
  function printNamedTupleMember(path, options2, print3) {
    ...
    return [// `TupleTypeLabeledElement` only
    node.variance ? print3("variance") : "", print3("label"), node.optional ? "?" : "", ": ", print3("elementType")];
  }
  ...
  var getTypeAnnotationFirstToken = path => {
    if ( // TypeScript
    path.match(node => node.type === "TSTypeAnnotation", (node, key) => (key === "returnType" || key === "typeAnnotation") && (node.type === "TSFunctionType" || node.type === "TSConstructorType"))) {
      return "=>";
    }

    if ( // TypeScript
    path.match(node => node.type === "TSTypeAnnotation", (node, key) => key === "typeAnnotation" && (node.type === "TSJSDocNullableType" || node.type === "TSJSDocNonNullableType" || node.type === "TSTypePredicate")) ||
    /*
    Flow
          ```js
    ...
    ```
    */
    path.match(node => node.type === "TypeAnnotation", (node, key) => key === "typeAnnotation" && node.type === "Identifier", (node, key) => key === "id" && node.type === "DeclareFunction") ||
    /*
    Flow
          ```js
    ...
    ```
    */
    path.match(node => node.type === "TypeAnnotation", (node, key) => key === "bound" && node.type === "TypeParameter" && node.usesExtendsBound)) {
      return "";
    }
  ...
  function printTypeQuery({
    node
  }, print3) {
    return ["typeof ", ...(node.type === "TSTypeQuery" ? [print3("exprName"), print3("typeParameters")] : [print3("argument")])];
  }
  ...
  function printTypePredicate(path, print3) {
    ...
    return [node.asserts ? "asserts " : "", print3("parameterName"), node.typeAnnotation ? [" is ", printTypeAnnotationProperty(path, print3)] : ""];
  ...
  function printDefiniteToken(path) {
    return path.node.definite || path.match(void 0, (node, name) => name === "id" && node.type === "VariableDeclarator" && node.definite) ? "!" : "";
  }

  var flowDeclareNodeTypes = /* @__PURE__ */new Set(["DeclareClass", "DeclareComponent", "DeclareFunction", "DeclareVariable", "DeclareExportDeclaration", "DeclareExportAllDeclaration", "DeclareOpaqueType", "DeclareTypeAlias", "DeclareEnum", "DeclareInterface"]);
  ...
  var tsAbstractNodeTypes = /* @__PURE__ */new Set(["TSAbstractMethodDefinition", "TSAbstractPropertyDefinition", "TSAbstractAccessorProperty"]);

  function printAbstractToken({
    node
  }) {
  ...
  function printClassMemberDecorators(path, options2, print3) {
    ...
    return group([join(line, path.map(print3, "decorators")), hasNewlineBetweenOrAfterDecorators(node, options2) ? hardline : line]);
  }
  ...
  function printDecoratorsBeforeExport(path, options2, print3) {
    ...
    return [join(hardline, path.map(print3, "declaration", "decorators")), hardline];
  }
  ...
  function printDecorators(path, options2, print3) {
    ...
    return [path.key === "declaration" && isExportDeclaration(parent) ? hardline : shouldBreak ? breakParent : "", join(line, path.map(print3, "decorators")), line];
  }

  function hasNewlineBetweenOrAfterDecorators(node, options2) {
    return node.decorators.some(decorator => has_newline_default(options2.originalText, locEnd(decorator)));
  }
  ...
  function printImportDeclaration(path, options2, print3) {
    ...
    return ["import", node.module ? " module" : "", printImportKind(node), printModuleSpecifiers(path, options2, print3), printModuleSource(path, options2, print3), printImportAttributes(path, options2, print3), options2.semi ? ";" : ""];
  }
  ...
  function printExportDeclaration(path, options2, print3) {
    ...
    const parts = [printDecoratorsBeforeExport(path, options2, print3), printDeclareToken(path), "export", isDefaultExport(node) ? " default" : ""];
    const {
      declaration,
      exported
    } = node;
    ...
    if (declaration) {
      ...
      parts.push(printModuleSource(path, options2, print3), printImportAttributes(path, options2, print3));
    }
  ...
  var shouldOmitSemicolon = create_type_check_function_default(["ComponentDeclaration", "ClassDeclaration", "FunctionDeclaration", "TSInterfaceDeclaration", "DeclareComponent", "DeclareClass", "DeclareFunction", "TSDeclareFunction", "EnumDeclaration"]);
  ...
  function printModuleSpecifiers(path, options2, print3) {
    ...
    if (is_non_empty_array_default(node.specifiers)) {
      ...
      if (groupedSpecifiers.length > 0) {
        ...
        if (canBreak2) {
          parts.push(group(["{", indent([options2.bracketSpacing ? line : softline, join([",", line], groupedSpecifiers)]), ifBreak(shouldPrintComma(options2) ? "," : ""), options2.bracketSpacing ? line : softline, "}"]));
        } else {
          parts.push(["{", options2.bracketSpacing ? " " : "", ...groupedSpecifiers, options2.bracketSpacing ? " " : "", "}"]);
        }
      }
    } else {
      parts.push("{}");
  ...
  function shouldNotPrintSpecifiers(node, options2) {
    ...
    return !/{\s*}/.test(options2.originalText.slice(locStart(node), locStart(source)));
  }
  ...
  function printImportAttributes(path, options2, print3) {
    ...
    return [` ${keyword} {`, options2.bracketSpacing ? " " : "", join(", ", path.map(print3, property)), options2.bracketSpacing ? " " : "", "}"];
  }
  ...
  function printModuleSpecifier(path, options2, print3) {
    ...
    return [printImportOrExportKind(type === "ImportSpecifier" ? node.importKind : node.exportKind,
    /* spaceBeforeKind */
    false), left, left && right ? " as " : "", right];
  }
  ...
  function printTernary(path, options2, print3) {
    ...
    if (isConditionalExpression && (isJsxElement(node[testNodePropertyNames[0]]) || isJsxElement(consequentNode) || isJsxElement(alternateNode) || conditionalExpressionChainContainsJsx(lastConditionalParent))) {
      ...
      parts.push(" ? ", isNil(consequentNode) ? print3(consequentNodePropertyName) : wrap(print3(consequentNodePropertyName)), " : ", alternateNode.type === node.type || isNil(alternateNode) ? print3(alternateNodePropertyName) : wrap(print3(alternateNodePropertyName)));
    } else {
      const part = [line, "? ", consequentNode.type === node.type ? ifBreak("", "(") : "", align(2, print3(consequentNodePropertyName)), consequentNode.type === node.type ? ifBreak("", ")") : "", line, ": ", alternateNode.type === node.type ? print3(alternateNodePropertyName) : align(2, print3(alternateNodePropertyName))];
      parts.push(parent.type !== node.type || parent[alternateNodePropertyName] === node || isParentTest ? part : options2.useTabs ? dedent(indent(part)) : align(Math.max(0, options2.tabWidth - 2), part));
    }

    const shouldBreak = [consequentNodePropertyName, alternateNodePropertyName, ...testNodePropertyNames].some(property => hasComment(node[property], comment => is_block_comment_default(comment) && has_newline_in_range_default(options2.originalText, locStart(comment), locEnd(comment))));
    ...
    const result = maybeGroup([printTernaryTest(path, options2, print3), forceNoIndent ? parts : indent(parts), isConditionalExpression && breakClosingParen && !shouldExtraIndent ? softline : ""]);
  ...
  var get_alignment_size_default = getAlignmentSize; // src/utils/get-indent-size.js
  ...
  function getIndentSize(value, tabWidth) {
    ...
    return get_alignment_size_default( // All the leading whitespaces
    value.slice(lastNewlineIndex + 1).match(/^[\t ]*/)[0], tabWidth);
  }

  var get_indent_size_default = getIndentSize; // src/common/end-of-line.js
        ...
        case DOC_TYPE_GROUP:
          {
            ...
            /* isOptionalObject*/
            false, doc.expandedStates, -1) : doc.contents;
            cmds.push({
              mode: groupMode,
              doc: contents
            });
  ...
  function printTemplateLiteral(path, print3, options2) {
    ...
    if (isSimple) {
      expressionDocs = expressionDocs.map(doc => printDocToString(doc, { ...options2,
  ...
  function printJestEachTemplateLiteral(path, options2, print3) {
    ...
    if (headerNames.length > 1 || headerNames.some(headerName => headerName.length > 0)) {
      ...
      const parts = [];
      const stringifiedExpressions = expressions.map(doc => "${" + printDocToString(doc, { ...options2,
        printWidth: Number.POSITIVE_INFINITY,
        endOfLine: "lf"
      }).formatted + "}");
      const tableBody = [{
  ...
  function escapeTemplateCharacters(doc, raw) {
    return mapDoc(doc, currentDoc => {
      if (typeof currentDoc === "string") {
        ...
        /* isOptionalObject*/
        false, currentDoc, /(\\*)`/g, "$1$1\\`") : uncookTemplateElementValue(currentDoc);
      }
  ...
  var create_group_id_mapper_default = createGroupIdMapper; // src/language-js/print/mapped-type.js
  ...
  function printFlowMappedTypeProperty(path, options2, print3) {
    ...
    return group([node.variance ? print3("variance") : "", "[", indent([print3("keyTparam"), " in ", print3("sourceType")]), "]", printFlowMappedTypeOptionalModifier(node.optional), ": ", print3("propType")]);
  }
  ...
  function printTypescriptMappedType(path, options2, print3) {
    ...
    const shouldBreak = has_newline_in_range_default(options2.originalText, locStart(node), // Ideally, this should be the next token after `{`, but there is no node starts with it.
    locStart(node.typeParameter));
    return group(["{", indent([options2.bracketSpacing ? line : softline, group([print3("typeParameter"), node.optional ? printTypeScriptMappedTypeModifier(node.optional, "?") : "", node.typeAnnotation ? ": " : "", print3("typeAnnotation")]), options2.semi ? ifBreak(";") : ""]), printDanglingComments(path, options2), options2.bracketSpacing ? line : softline, "}"], {
      shouldBreak
    });
  ...
  function printTypeParameters(path, options2, print3, paramsKey) {
    ...
    if (shouldInline) {
      return ["<", join(", ", path.map(print3, paramsKey)), printDanglingCommentsForInline(path, options2), ">"];
    }
    ...
    return group(["<", indent([softline, join([",", line], path.map(print3, paramsKey))]), trailingComma, softline, ">"], {
  ...
  function printTypeParameter(path, options2, print3) {
    ...
    if (parent.type === "TSMappedType") {
      ...
      if (parent.nameType) {
        parts.push(" as ", path.callParent(() => print3("nameType")));
      }
    ...
    if (node.constraint) {
      ...
      parts.push(" extends", group(indent(line), {
        id: groupId
      }), lineSuffixBoundary, indentIfBreak(print3("constraint"), {
        groupId
      }));
    }
  ...
  var assert_default = assert; // src/language-js/print/property.js
  ...
  function printPropertyKey(path, options2, print3) {
    ...
    if (options2.quoteProps === "consistent" && !needsQuoteProps.has(parent)) {
      const objectHasStringProp = (parent.properties || parent.body || parent.members).some(prop => !prop.computed && prop.key && isStringLiteral(prop.key) && !isStringPropSafeToUnquote(prop, options2));
    ...
    !(options2.parser === "typescript" || options2.parser === "babel-ts")) && (options2.parser === "json" || options2.quoteProps === "consistent" && needsQuoteProps.get(parent))) {
      const prop = print_string_default(JSON.stringify(key.type === "Identifier" ? key.name : key.value.toString()), options2);
    ...
    if (isStringPropSafeToUnquote(node, options2) && (options2.quoteProps === "as-needed" || options2.quoteProps === "consistent" && !needsQuoteProps.get(parent))) {
      return path.call(keyPath => printComments(keyPath, /^\d/.test(key.value) ? print_number_default(key.value) : key.value, options2), "key");
    }
  ...
  function printProperty(path, options2, print3) {
    ...
    return printAssignment(path, options2, print3, printPropertyKey(path, options2, print3), ":", "value");
  ...
  function printFunction(path, print3, options2, args) {
    ...
    if ((node.type === "FunctionDeclaration" || node.type === "FunctionExpression") && (args == null ? void 0 : args.expandLastArg)) {
      ...
      if (isCallExpression(parent) && (getCallArguments(parent).length > 1 || getFunctionParameters(node).every(param => param.type === "Identifier" && !param.typeAnnotation))) {
        expandArg = true;
      }
    }

    const parts = [printDeclareToken(path), node.async ? "async " : "", `function${node.generator ? "*" : ""} `, node.id ? print3("id") : ""];
    const parametersDoc = printFunctionParameters(path, print3, options2, expandArg);
    ...
    parts.push(printFunctionTypeParameters(path, options2, print3), group([shouldGroupParameters ? group(parametersDoc) : parametersDoc, returnTypeDoc]), node.body ? " " : "", print3("body"));
  ...
  function printMethod(path, options2, print3) {
    ...
    parts.push(printPropertyKey(path, options2, print3), node.optional || node.key.optional ? "?" : "", node === value ? printMethodValue(path, options2, print3) : print3("value"));
    return parts;
  }
  ...
  function printMethodValue(path, options2, print3) {
    ...
    const shouldGroupParameters = shouldGroupFunctionParameters(node, returnTypeDoc);
    const parts = [printFunctionTypeParameters(path, options2, print3), group([shouldBreakParameters ? group(parametersDoc, {
      shouldBreak: true
    }) : shouldGroupParameters ? group(parametersDoc) : parametersDoc, returnTypeDoc])];
  ...
  function returnArgumentHasLeadingComment(options2, argument) {
    if (hasLeadingOwnLineComment(options2.originalText, argument) || hasComment(argument, CommentCheckFlags.Leading, comment => has_newline_in_range_default(options2.originalText, locStart(comment), locEnd(comment))) && !isJsxElement(argument)) {
      return true;
    }
  ...
  var isClassProperty = create_type_check_function_default(["ClassProperty", "PropertyDefinition", "ClassPrivateProperty", "ClassAccessorProperty", "AccessorProperty", "TSAbstractPropertyDefinition", "TSAbstractAccessorProperty"]);
  ...
  function printClass(path, options2, print3) {
    ...
    if (node.superClass) {
      const printed = [printSuperClass(path, options2, print3), print3("superTypeParameters")];
      const printedWithComments = path.call(superClass => ["extends ", printComments(superClass, printed, options2)], "superClass");
    ...
    extendsParts.push(printHeritageClauses(path, options2, print3, "mixins"), printHeritageClauses(path, options2, print3, "implements"));
  ...
  function printHeritageClauses(path, options2, print3, listName) {
    ...
    }) : line, printedLeadingComments, printedLeadingComments && hardline, listName, group(indent([line, join([",", line], path.map(print3, listName))]))];
  }
  ...
  function printClassProperty(path, options2, print3) {
    ...
    parts.push(printPropertyKey(path, options2, print3), printOptionalToken(path), printDefiniteToken(path), printTypeAnnotationProperty(path, print3));
    const isAbstractProperty = node.type === "TSAbstractPropertyDefinition" || node.type === "TSAbstractAccessorProperty";
    return [printAssignment(path, options2, print3, parts, " =", isAbstractProperty ? void 0 : "value"), semi];
  }
  ...
  function printClassBody(path, options2, print3) {
    ...
    return [is_non_empty_array_default(node.body) ? printHardlineAfterHeritage(path.parent) : "", "{", parts.length > 0 ? [indent([hardline, parts]), hardline] : "", "}"];
  }
  ...
  function printObject(path, options2, print3) {
    ...
    if (node.inexact || node.hasUnknownMembers) {
      ...
      if (hasComment(node, CommentCheckFlags.Dangling)) {
        ...
        /* isOptionalObject*/
        false, getComments(node), -1))) ? hardline : line, "..."];
      } else {
        printed = ["..."];
      }
    ...
    /* isOptionalObject*/
    false, propsAndLoc, -1)) == null ? void 0 : _a.node;
  ...
  function shouldAddParensIfNotBreak(node) {
    if (!shouldAddParensIfNotBreakCache.has(node)) {
      shouldAddParensIfNotBreakCache.set(node, node.type === "ConditionalExpression" && !startsWithNoLookaheadToken(node, node2 => node2.type === "ObjectExpression"));
    }
  ...
  function printArrowFunction(path, options2, print3, args = {}) {
    ...
    (function rec() {
      ...
      const signatureDoc = printArrowFunctionSignature(path, options2, print3, args);
    ...
    return group([group(shouldIndentSignatures ? indent([softline, signaturesDoc]) : signaturesDoc, {
      shouldBreak: shouldBreakSignatures,
      id: chainGroupId
    }), " =>", shouldPrintAsChain ? indentIfBreak(bodyDoc, {
      groupId: chainGroupId
    }) : group(bodyDoc), shouldPrintAsChain && isCallee ? ifBreak(softline, "", {
      groupId: chainGroupId
    }) : ""]);
  }
  ...
  function printArrowFunctionSignature(path, options2, print3, args) {
    ...
    if (shouldPrintParamsWithoutParens(path, options2)) {
      ...
      parts.push(group([printFunctionParameters(path, print3, options2, expandArg,
      /* printTypeParams */
      true), returnTypeDoc]));
    }
    ...
    const dangling = printDanglingComments(path, options2, {
      filter(comment) {
        const nextCharacter = get_next_non_space_non_comment_character_index_default(options2.originalText, locEnd(comment));
  ...
  function printArrowFunctionSignatures(path, args, {
    signatureDocs,
    shouldBreak
  }) {
    ...
    if (key !== "callee" && isCallLikeExpression(parent) || isBinaryish(parent)) {
      return group([signatureDocs[0], " =>", indent([line, join([" =>", line], signatureDocs.slice(1))])], {
        shouldBreak
      });
    }
  ...
  function printArrowFunctionBody(path, options2, args, {
    bodyDoc,
    bodyComments,
    functionBody,
    shouldPutBodyOnSameLine
  ...
  function printBlockBody(path, options2, print3) {
    ...
    if (hasDirectives) {
      ...
      if (hasBody || hasDanglingComments) {
        ...
        /* isOptionalObject*/
        false, node.directives, -1), options2)) {
          parts.push(hardline);
        }
      }
    }
  ...
  function expressionNeedsASIProtection(path, options2) {
    ...
    return path.call(() => expressionNeedsASIProtection(path, options2), ...getLeftSidePathName(node));
  }

  function isSingleJsxExpressionStatementInMarkdown({
    node,
    parent
  }, options2) {
  ...
  function isSingleVueEventBindingExpressionStatement({
    node,
    parent
  }, options2) {
  ...
  function printExpressionStatement(path, options2, print3) {
    ...
    } else if (isSingleJsxExpressionStatementInMarkdown(path, options2)) {} else if (options2.semi) {
      parts.push(";");
    }

    if (hasComment(path.node, CommentCheckFlags.Dangling, ({
      marker
  ...
  function printHtmlBinding(path, options2, print3) {
    ...
    if (options2.__isEmbeddedTypescriptGenericParameters) {
      const parameterDocs = path.map(print3, "program", "body", 0, "typeParameters", "params");
  ...
  function printEstree(path, options2, print3, args) {
    ...
    switch (node.type) {
      ...
      case "File":
        return (_printHtmlBinding = printHtmlBinding(path, options2, print3)) != null ? _printHtmlBinding : print3("program");
      ...
      case "ParenthesizedExpression":
        {
          ...
          return group(["(", indent([softline, print3("expression")]), softline, ")"]);
        }
      ...
      case "BindExpression":
        ...
        parts.push(group(indent([softline, printBindExpressionCallee(path, options2, print3)])));
        return parts;

      case "Identifier":
        return [node.name, printOptionalToken(path), printDefiniteToken(path), printTypeAnnotationProperty(path, print3)];
      ...
      case "AwaitExpression":
        ...
        if (node.argument) {
          ...
          if (isCallExpression(parent) && parent.callee === node || isMemberExpression(parent) && parent.object === node) {
            ...
            if ((parentAwaitOrBlock == null ? void 0 : parentAwaitOrBlock.type) !== "AwaitExpression" || !startsWithNoLookaheadToken(parentAwaitOrBlock.argument, leftmostNode => leftmostNode === node)) {
              return group(parts);
            }
          }
        }
      ...
      case "VariableDeclaration":
        {
          ...
          parts = [printDeclareToken(path), node.kind, firstVariable ? [" ", firstVariable] : "", indent(printed.slice(1).map(p => [",", hasValue && !isParentForLoop ? hardline : line, p]))];
      ...
      case "WithStatement":
        return group(["with (", print3("object"), ")", adjustClause(node.body, print3("body"))]);

      case "IfStatement":
        {
          const con = adjustClause(node.consequent, print3("consequent"));
          const opening = group(["if (", group([indent([softline, print3("test")]), softline]), ")", con]);
          parts.push(opening);
          ...
          if (node.alternate) {
            ...
            if (hasComment(node, CommentCheckFlags.Dangling)) {
              parts.push(printDanglingComments(path, options2), commentOnOwnLine ? hardline : " ");
            }

            parts.push("else", group(adjustClause(node.alternate, print3("alternate"), node.alternate.type === "IfStatement")));
          }
      ...
      case "ForStatement":
        {
          ...
          return [printedComments, group(["for (", group([indent([softline, print3("init"), ";", line, print3("test"), ";", line, print3("update")]), softline]), ")", body])];
        }

      case "WhileStatement":
        return group(["while (", group([indent([softline, print3("test")]), softline]), ")", adjustClause(node.body, print3("body"))]);

      case "ForInStatement":
        return group(["for (", print3("left"), " in ", print3("right"), ")", adjustClause(node.body, print3("body"))]);

      case "ForOfStatement":
        return group(["for", node.await ? " await" : "", " (", print3("left"), " of ", print3("right"), ")", adjustClause(node.body, print3("body"))]);
      ...
      case "DoWhileStatement":
        {
          ...
          parts.push("while (", group([indent([softline, print3("test")]), softline]), ")", semi);
          return parts;
        }
      ...
      case "TryStatement":
        return ["try ", print3("block"), node.handler ? [" ", print3("handler")] : "", node.finalizer ? [" finally ", print3("finalizer")] : ""];

      case "CatchClause":
        if (node.param) {
          const parameterHasComments = hasComment(node.param, comment => !is_block_comment_default(comment) || comment.leading && has_newline_default(options2.originalText, locEnd(comment)) || comment.trailing && has_newline_default(options2.originalText, locStart(comment), {
            backwards: true
          }));
          const param = print3("param");
          return ["catch ", parameterHasComments ? ["(", indent([softline, param]), softline, ") "] : ["(", param, ") "], print3("body")];
        }

        return ["catch ", print3("body")];

      case "SwitchStatement":
        return [group(["switch (", indent([softline, print3("discriminant")]), softline, ")"]), " {", node.cases.length > 0 ? indent([hardline, join(hardline, path.map(({
          node: node2,
          isLast
        }) => [print3(), !isLast && isNextLineEmpty2(node2, options2) ? hardline : ""], "cases"))]) : "", hardline, "}"];
  ...
  function printAngular(path, options2, print3) {
    ...
    switch (node.type) {
      case "NGRoot":
        return [print3("node"), hasComment(node.node) ? " //" + getComments(node.node)[0].value.trimEnd() : ""];

      case "NGPipeExpression":
        return printBinaryishExpression(path, options2, print3);

      case "NGChainedExpression":
        return group(join([";", line], path.map(() => hasNgSideEffect(path) ? print3() : ["(", print3(), ")"], "expressions")));

      case "NGEmptyExpression":
        return "";

      case "NGMicrosyntax":
        return path.map(() => [path.isFirst ? "" : isNgForOf(path) ? " " : [";", line], print3()], "body");

      case "NGMicrosyntaxKey":
        return /^[$_a-z][\w$]*(?:-[$_a-z][\w$])*$/i.test(node.name) ? node.name : JSON.stringify(node.name);

      case "NGMicrosyntaxExpression":
        return [print3("expression"), node.alias === null ? "" : [" as ", print3("alias")]];
      ...
      case "NGMicrosyntaxKeyedExpression":
        {
          ...
          return [print3("key"), shouldNotPrintColon ? " " : ": ", print3("expression")];
        }

      case "NGMicrosyntaxLet":
        return ["let ", print3("key"), node.value === null ? "" : [" = ", print3("value")]];
  ...
  var hasSideEffect = create_type_check_function_default(["CallExpression", "OptionalCallExpression", "AssignmentExpression"]);

  function hasNgSideEffect({
    node
  }) {
  ...
  function printBinaryCastExpression(path, options2, print3) {
    ...
    switch (node.type) {
      ...
      case "SatisfiesExpression":
      case "TSSatisfiesExpression":
        parts = [print3("expression"), " ", "satisfies", " ", print3("typeAnnotation")];
        break;
    }
  ...
  function printInterface(path, options2, print3) {
    ...
    const shouldIndentOnlyHeritageClauses2 = node.typeParameters && !hasComment(node.typeParameters, CommentCheckFlags.Trailing | CommentCheckFlags.Line);

    if (is_non_empty_array_default(node.extends)) {
      extendsParts.push(shouldIndentOnlyHeritageClauses2 ? ifBreak(" ", line, {
        groupId: getTypeParametersGroupId(node.typeParameters)
      }) : line, "extends ", (node.extends.length === 1 ? identity : indent)(join([",", line], path.map(print3, "extends"))));
    }
  ...
  function printEnumDeclaration(path, print3, options2) {
    ...
    return [printDeclareToken(path), node.const ? "const " : "", "enum ", print3("id"), " ", node.type === "TSEnumDeclaration" ? printEnumMembers(path, print3, options2) : print3("body")];
  ...
  function printFlow(path, options2, print3) {
    var _node$kind, _node$raw, _node$raw2;
    ...
    switch (node.type) {
      ...
      case "DeclareFunction":
        return [printDeclareToken(path), "function ", print3("id"), print3("predicate"), semi];

      case "DeclareModule":
        return ["declare module ", print3("id"), " ", print3("body")];

      case "DeclareModuleExports":
        return ["declare module.exports", printTypeAnnotationProperty(path, print3), semi];

      case "DeclareVariable":
        return [printDeclareToken(path), // TODO: Only use `node.kind` when babel update AST
        (_node$kind = node.kind) != null ? _node$kind : "var", " ", print3("id"), semi];
      ...
      case "GenericTypeAnnotation":
        return [print3("id"), printTypeParameters(path, options2, print3, "typeParameters")];
      ...
      case "FunctionTypeParam":
        {
          ...
          return [name, printOptionalToken(path), // `flow` doesn't wrap the `typeAnnotation` with `TypeAnnotation`, so the colon
          // needs to be added separately.
          name ? ": " : "", print3("typeAnnotation")];
        }
      ...
      case "ObjectTypeIndexer":
        return [node.static ? "static " : "", node.variance ? print3("variance") : "", "[", print3("id"), node.id ? ": " : "", print3("key"), "]: ", print3("value")];
      ...
      case "ObjectTypeProperty":
        {
          ...
          return [modifier, isGetterOrSetter(node) ? node.kind + " " : "", node.variance ? print3("variance") : "", printPropertyKey(path, options2, print3), printOptionalToken(path), isFunctionNotation(node) ? "" : ": ", print3("value")];
        }
      ...
      case "ObjectTypeInternalSlot":
        return [node.static ? "static " : "", "[[", print3("id"), "]]", printOptionalToken(path), node.method ? "" : ": ", print3("value")];
      ...
      case "NumberLiteralTypeAnnotation":
        return print_number_default((_node$raw = node.raw) != null ? _node$raw : node.extra.raw);

      case "BigIntLiteralTypeAnnotation":
        return printBigInt((_node$raw2 = node.raw) != null ? _node$raw2 : node.extra.raw);

      case "TypeCastExpression":
        return ["(", print3("expression"), printTypeAnnotationProperty(path, print3), ")"];
      ...
      case "DeclaredPredicate":
        return [// The return type will already add the colon, but otherwise we
        // need to do it ourselves
        path.key === "predicate" && path.parent.type !== "DeclareFunction" && !path.parent.returnType ? ": " : " ", "%checks", ...(node.type === "DeclaredPredicate" ? ["(", print3("value"), ")"] : [])];
  ...
  function printTypescript(path, options2, print3) {
    ...
    switch (node.type) {
      ...
      case "TSTypeAssertion":
        {
          ...
          const castGroup = group(["<", indent([softline, print3("typeAnnotation")]), softline, ">"]);
          const exprContents = [ifBreak("("), indent([softline, print3("expression")]), softline, ifBreak(")")];

          if (shouldBreakAfterCast) {
            return conditionalGroup([[castGroup, print3("expression")], [castGroup, group(exprContents, {
              shouldBreak: true
      ...
      case "TSPropertySignature":
        return [node.readonly ? "readonly " : "", printPropertyKey(path, options2, print3), printOptionalToken(path), printTypeAnnotationProperty(path, print3)];

      case "TSParameterProperty":
        return [printTypeScriptAccessibilityToken(node), node.static ? "static " : "", node.override ? "override " : "", node.readonly ? "readonly " : "", print3("parameter")];
      ...
      case "TSIndexSignature":
        {
          ...
          const parametersGroup = group([indent([softline, join([", ", softline], path.map(print3, "parameters"))]), trailingComma, softline]);
          const isClassMember = path.parent.type === "ClassBody" && path.key === "body";
          return [// `static` only allowed in class member
          isClassMember && node.static ? "static " : "", node.readonly ? "readonly " : "", "[", node.parameters ? parametersGroup : "", "]", printTypeAnnotationProperty(path, print3), isClassMember ? semi : ""];
        }
      ...
      case "TSImportType":
        return [!node.isTypeOf ? "" : "typeof ", "import(", print3("argument"), ")", !node.qualifier ? "" : [".", print3("qualifier")], printTypeParameters(path, options2, print3, node.typeArguments ? "typeArguments" : "typeParameters")];
      ...
      case "TSMethodSignature":
        {
          ...
          parts.push(printTypeScriptAccessibilityToken(node), kind, node.computed ? "[" : "", print3("key"), node.computed ? "]" : "", printOptionalToken(path));
          const parametersDoc = printFunctionParameters(path, print3, options2,
          /* expandArg */
          false,
          /* printTypeParams */
      ...
      case "TSImportEqualsDeclaration":
        return [node.isExport ? "export " : "", "import ", printImportKind(node,
        /* spaceBeforeKind */
        false), print3("id"), " = ", print3("moduleReference"), options2.semi ? ";" : ""];
      ...
      case "TSModuleDeclaration":
        {
          ...
          if (parentIsDeclaration) {
            ...
            if (!isGlobal) {
              ...
              const kind = (_node$kind2 = node.kind) != null ? _node$kind2 : // TODO: Use `node.kind` when babel update AST
              isStringLiteral(node.id) || /(?:^|\s)module(?:\s|$)/.test(options2.originalText.slice(locStart(node), locStart(node.id))) ? "module" : "namespace";
              parts.push(kind, " ");
            }
          }
      ...
      case "TSTypeReference":
        return [print3("typeName"), printTypeParameters(path, options2, print3, "typeParameters")];
  ...
  var shouldPrintDirectly = create_type_check_function_default(["ClassMethod", "ClassPrivateMethod", "ClassProperty", "ClassAccessorProperty", "AccessorProperty", "TSAbstractAccessorProperty", "PropertyDefinition", "TSAbstractPropertyDefinition", "ClassPrivateProperty", "MethodDefinition", "TSAbstractMethodDefinition", "TSDeclareMethod"]);
  ...
  function print(path, options2, print3, args) {
    ...
    return inheritLabel(doc, doc2 => [needsSemi ? ";" : "", needsParens2 ? "(" : "", needsParens2 && isClassExpression && hasDecorators ? [indent([line, decoratorsDoc, doc2]), line] : [decoratorsDoc, doc2], needsParens2 ? ")" : ""]);
  }

  var print_default = print; // src/language-js/embed/utils.js
  ...
  function isAngularComponentStyles(path) {
    return path.match(node => node.type === "TemplateLiteral", (node, name) => isArrayOrTupleExpression(node) && name === "elements", (node, name) => isObjectProperty(node) && node.key.type === "Identifier" && node.key.name === "styles" && name === "value", ...angularComponentObjectExpressionPredicates);
  }
  ...
  function printEmbedCss(textToDoc, print3, path) {
    ...
    const quasisDoc = textToDoc(text, {
      parser: "scss"
    });
  ...
  function isStyledJsx({
    ...
    return grandparent && node.quasis && parent.type === "JSXExpressionContainer" && grandparent.type === "JSXElement" && grandparent.openingElement.name.name === "style" && grandparent.openingElement.attributes.some(attribute => attribute.name.name === "jsx") || (parent == null ? void 0 : parent.type) === "TaggedTemplateExpression" && parent.tag.type === "Identifier" && parent.tag.name === "css" || (parent == null ? void 0 : parent.type) === "TaggedTemplateExpression" && parent.tag.type === "MemberExpression" && parent.tag.object.name === "css" && (parent.tag.property.name === "global" || parent.tag.property.name === "resolve");
  }
  ...
  var css_default = printCss; // src/language-js/embed/graphql.js
  ...
  var graphql_default = printGraphql; // src/language-js/embed/html.js
  ...
  var html_default = printHtml; // src/language-js/embed/markdown.js
  ...
  function printEmbedMarkdown(textToDoc, print3, path) {
    ...
    /* isOptionalObject*/
    false, node.quasis[0].value.raw, /((?:\\\\)*)\\`/g, (_, backslashes) => "\\".repeat(backslashes.length / 2) + "`");
    ...
    if (hasIndent) {
      text = string_replace_all_default(
      /* isOptionalObject*/
      false, text, new RegExp(`^${indentation}`, "gm"), "");
    }
  ...
  var markdown_default = printMarkdown; // src/language-js/embed/index.js
  ...
  function embed(path) {
    ...
    for (const getEmbedder of [css_default, graphql_default, html_default, markdown_default]) {
  ...
  var embed_default = embed; // src/language-js/clean.js
  ...
  var clean_default = clean; // src/language-js/pragma.js

  var import_jest_docblock = __toESM(require_build(), 1); // src/language-js/utils/get-shebang.js
  ...
  var get_shebang_default = getShebang; // src/language-js/pragma.js
...
` : "") + docBlock + (strippedText.startsWith("\n") ? "\n" : "\n\n") + strippedText;
  ...
  var visitor_keys_default = visitorKeys; // src/language-json/get-visitor-keys.js

  var getVisitorKeys2 = create_get_visitor_keys_default(visitor_keys_default);
  var get_visitor_keys_default2 = getVisitorKeys2; // src/language-json/printer-estree-json.js
      ...
      case "ArrayExpression":
        {
          ...
          const printed = path.map(() => path.node === null ? "null" : print3(), "elements");
          return ["[", indent([hardline, join([",", hardline], printed)]), hardline, "]"];
        }

      case "ObjectExpression":
        return node.properties.length === 0 ? "{}" : ["{", indent([hardline, join([",", hardline], path.map(print3, "properties"))]), hardline, "}"];
  ...
  var ignoredProperties2 = /* @__PURE__ */new Set(["start", "end", "extra", "loc", "comments", "leadingComments", "trailingComments", "innerComments", "errors", "range", "tokens"]);
  ...
  clean2.ignoredProperties = ignoredProperties2; // src/language-json/languages.evaluate.js
  ...
  var languages_evaluate_default2 = [{
    ...
    "filenames": [".all-contributorsrc", ".arcconfig", ".auto-changelog", ".c8rc", ".htmlhintrc", ".imgbotconfig", ".nycrc", ".tern-config", ".tern-project", ".watchmanconfig", "Pipfile.lock", "composer.lock", "flake.lock", "mcmod.info"],
    "parsers": ["json"],
    "vscodeLanguageIds": ["json"]
  }, {
    ...
    "filenames": [".babelrc", ".devcontainer.json", ".eslintrc.json", ".jscsrc", ".jshintrc", ".jslintrc", ".swcrc", "api-extractor.json", "devcontainer.json", "jsconfig.json", "language-configuration.json", "tsconfig.json", "tslint.json", ".eslintrc"],
    "parsers": ["json"],
  ...
  var options_default = options; // src/plugins/estree.js
