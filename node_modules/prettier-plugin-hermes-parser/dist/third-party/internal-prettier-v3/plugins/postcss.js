...
(function (factory) {
  ...
  var __toCommonJS = mod => __copyProps(__defProp({}, "__esModule", {
    value: true
  }), mod); // node_modules/jest-docblock/build/index.js
      ...
      var CssSyntaxError = class _CssSyntaxError extends Error {
        ...
        showSourceCode(color) {
          ...
          if (terminalHighlight) {
            if (color) css2 = terminalHighlight(css2);
          }
    ...
    "node_modules/postcss/lib/input.js"(exports, module) {
      ...
      var Input = class {
        ...
        error(message, line2, column, opts = {}) {
          ...
          if (origin) {
            result = new CssSyntaxError(message, origin.endLine === void 0 ? origin.line : {
            ...
            result = new CssSyntaxError(message, endLine === void 0 ? line2 : {
              column,
              line: line2
        ...
        while (pos < length) {
          ...
          switch (code) {
            ...
            case feed:
              ...
              tokens.push(["space", css2.slice(pos, next), line2, pos - offset, line2, next - offset, pos]);
              pos = next - 1;
              break;

            case colon:
              next = pos + 1;
              tokens.push(["colon", css2.slice(pos, next), line2, pos - offset, line2, next - offset, pos]);
              pos = next - 1;
              break;

            case comma:
              next = pos + 1;
              tokens.push(["comma", css2.slice(pos, next), line2, pos - offset, line2, next - offset, pos]);
              pos = next - 1;
              break;

            case openBracket:
              tokens.push(["{", "{", line2, pos - offset, line2, next - offset, pos]);
              break;
            ...
            case at2:
              ...
              tokens.push(["atword", css2.slice(pos, next + 1), line2, pos - offset, line2, next - offset, pos]);
              pos = next;
              break;
            ...
            case asterisk:
              ...
              if (code === minus && nextChar.charCodeAt(0) === minus) {
                next++;
                tokens.push(["word", css2.slice(pos, next), line2, pos - offset, line2, next - offset, pos]);
                pos = next - 1;
                break;
              }

              tokens.push(["operator", css2.slice(pos, next), line2, pos - offset, line2, next - offset, pos]);
              pos = next - 1;
              break;
            ...
            default:
              if (code === slash && (css2.charCodeAt(pos + 1) === asterisk || options2.loose && !isURLArg && css2.charCodeAt(pos + 1) === slash)) {
                ...
                next = pos + 1;
                tokens.push(["#", css2.slice(pos, next), line2, pos - offset, line2, next - offset, pos]);
                pos = next - 1;
                ...
                tokens.push(["unicoderange", css2.slice(pos, next), line2, pos - offset, line2, next - offset, pos]);
                pos = next - 1;
              } else if (code === slash) {
                next = pos + 1;
                tokens.push(["operator", css2.slice(pos, next), line2, pos - offset, line2, next - offset, pos]);
                ...
                if (regex === wordEndNum || code === period) {
                  let ncode = css2.charCodeAt(next),
                      ncode1 = css2.charCodeAt(next + 1),
                      ncode2 = css2.charCodeAt(next + 2);
      ...
      var _class = function () {
        function _class2() {
          ...
          var _opts$spaces$before = _opts$spaces.before,
              before = _opts$spaces$before === void 0 ? "" : _opts$spaces$before,
              _opts$spaces$after = _opts$spaces.after,
              after = _opts$spaces$after === void 0 ? "" : _opts$spaces$after;
          this.spaces = {
            before,
            after
          };
  ...
  var string_replace_all_default = stringReplaceAll; // src/utils/get-preferred-quote.js
  ...
  var get_preferred_quote_default = getPreferredQuote; // src/utils/make-string.js
  ...
  function makeString(rawText, enclosingQuote, unescapeUnnecessaryEscapes) {
    ...
    /* isOptionalObject*/
    false, rawText, regex, (match, escaped, quote) => {
  ...
  var print_string_default = printString; // src/utils/is-non-empty-array.js

  function isNonEmptyArray(object) {
    return Array.isArray(object) && object.length > 0;
  }

  var is_non_empty_array_default = isNonEmptyArray; // src/document/constants.js
...
Expected it to be ${EXPECTED_TYPE_VALUES}.`;
  ...
  var invalid_doc_error_default = InvalidDocError; // src/document/utils/assert-doc.js
  ...
  var unexpected_node_error_default = UnexpectedNodeError; // src/utils/front-matter/is-front-matter.js

  function isFrontMatter(node) {
    return (node == null ? void 0 : node.type) === "front-matter";
  }

  var is_front_matter_default = isFrontMatter; // src/language-css/clean.js

  var ignoredProperties = /* @__PURE__ */new Set(["raw", // front-matter
  "raws", "sourceIndex", "source", "before", "after", "trailingComma", "spaces"]);
  ...
  function clean(ast, newObj, parent) {
    ...
    if ((ast.type === "media-value" || ast.type === "media-type" || ast.type === "value-number" || ast.type === "selector-root-invalid" || ast.type === "selector-class" || ast.type === "selector-combinator" || ast.type === "selector-tag") && newObj.value) {
      newObj.value = string_replace_all_default(
      /* isOptionalObject*/
      false, newObj.value, /([\d+.Ee-]+)([A-Za-z]*)/g, (match, numStr, unit) => {
  ...
  function cleanCSSStrings(value) {
    ...
    /* isOptionalObject*/
    false, value, "'", '"'), /\\([^\dA-Fa-f])/g, "$1");
  }

  var clean_default = clean; // src/utils/front-matter/print.js
  ...
  var print_default = print; // src/language-css/embed.js
  ...
  var embed_default = embed; // src/language-js/pragma.js
...
` : "") + docBlock + (strippedText.startsWith("\n") ? "\n" : "\n\n") + strippedText;
  ...
  var parse_default = parse; // src/language-css/pragma.js
  ...
  var create_get_visitor_keys_default = createGetVisitorKeys; // src/language-css/visitor-keys.js
  ...
  var visitor_keys_default = visitorKeys; // src/language-css/get-visitor-keys.js

  var getVisitorKeys = create_get_visitor_keys_default(visitor_keys_default);
  var get_visitor_keys_default = getVisitorKeys; // src/language-css/utils/index.js
  ...
  var skipEverythingButNewLine = skip(/[^\n\r]/); // src/utils/line-column-to-index.js
  ...
  var line_column_to_index_default = lineColumnToIndex; // src/language-css/loc.js
  ...
  function replaceQuotesInInlineComments(text) {
    ...
    for (const [start, end] of inlineCommentsToReplace) {
      ...
      /* isOptionalObject*/
      false, text.slice(start, end), /["'*]/g, " ") + text.slice(end);
    }
  ...
  var print_number_default = printNumber; // src/language-css/print/css-units.evaluate.js

  var css_units_evaluate_default = /* @__PURE__ */new Map([["em", "em"], ["rem", "rem"], ["ex", "ex"], ["rex", "rex"], ["cap", "cap"], ["rcap", "rcap"], ["ch", "ch"], ["rch", "rch"], ["ic", "ic"], ["ric", "ric"], ["lh", "lh"], ["rlh", "rlh"], ["vw", "vw"], ["svw", "svw"], ["lvw", "lvw"], ["dvw", "dvw"], ["vh", "vh"], ["svh", "svh"], ["lvh", "lvh"], ["dvh", "dvh"], ["vi", "vi"], ["svi", "svi"], ["lvi", "lvi"], ["dvi", "dvi"], ["vb", "vb"], ["svb", "svb"], ["lvb", "lvb"], ["dvb", "dvb"], ["vmin", "vmin"], ["svmin", "svmin"], ["lvmin", "lvmin"], ["dvmin", "dvmin"], ["vmax", "vmax"], ["svmax", "svmax"], ["lvmax", "lvmax"], ["dvmax", "dvmax"], ["cm", "cm"], ["mm", "mm"], ["q", "Q"], ["in", "in"], ["pt", "pt"], ["pc", "pc"], ["px", "px"], ["deg", "deg"], ["grad", "grad"], ["rad", "rad"], ["turn", "turn"], ["s", "s"], ["ms", "ms"], ["hz", "Hz"], ["khz", "kHz"], ["dpi", "dpi"], ["dpcm", "dpcm"], ["dppx", "dppx"], ["x", "x"], ["cqw", "cqw"], ["cqh", "cqh"], ["cqi", "cqi"], ["cqb", "cqb"], ["cqmin", "cqmin"], ["cqmax", "cqmax"]]); // src/language-css/print/misc.js
  ...
  function adjustStrings(value, options2) {
    return string_replace_all_default(
    /* isOptionalObject*/
    false, value, STRING_REGEX, match => print_string_default(match, options2));
  }
  ...
  function adjustNumbers(value) {
    return string_replace_all_default(
    /* isOptionalObject*/
    false, value, ADJUST_NUMBERS_REGEX, (match, quote, wordPart, number, unit) => !wordPart && number ? printCssNumber(number) + maybeToLowerCase(unit || "") : match);
  }
  ...
  function printCommaSeparatedValueGroup(path, options2, print3) {
    ...
    const atRuleAncestorNode = path.findAncestor(node2 => node2.type === "css-atrule");
  ...
  var comma_separated_value_group_default = printCommaSeparatedValueGroup; // src/utils/skip-newline.js
  ...
  var skip_newline_default = skipNewline; // src/utils/skip-inline-comment.js
  ...
  var skip_trailing_comment_default = skipTrailingComment; // src/utils/has-newline.js
  ...
  var has_newline_default = hasNewline; // src/utils/is-next-line-empty.js
  ...
  var is_next_line_empty_default = isNextLineEmpty; // src/language-css/print/parenthesized-value-group.js
  ...
  var sequence_default = printSequence; // src/language-css/printer-postcss.js
  ...
  function genericPrint(path, options2, print3) {
    ...
    switch (node.type) {
      ...
      case "css-decl":
        {
          ...
          return [string_replace_all_default(
          /* isOptionalObject*/
          false, node.raws.before, /[\s;]/g, ""), // Less variable
          parentNode.type === "css-atrule" && parentNode.variable || insideICSSRuleNode(path) ? node.prop : maybeToLowerCase(node.prop), trimmedBetween.startsWith("//") ? " " : "", trimmedBetween, node.extend || isValueAllSpace ? "" : " ", options2.parser === "less" && node.extend && node.selector ? ["extend(", print3("selector"), ")"] : "", value, node.raws.important ? node.raws.important.replace(/\s*!\s*important/i, " !important") : node.important ? " !important" : "", node.raws.scssDefault ? node.raws.scssDefault.replace(/\s*!default/i, " !default") : node.scssDefault ? " !default" : "", node.raws.scssGlobal ? node.raws.scssGlobal.replace(/\s*!global/i, " !global") : node.scssGlobal ? " !global" : "", node.nodes ? [" {", indent([softline, sequence_default(path, options2, print3)]), softline, "}"] : isTemplatePropNode(node) && !parentNode.raws.semicolon && options2.originalText[locEnd(node) - 1] !== ";" ? "" : options2.__isHTMLStyleAttribute && isLastNode(path, node) ? ifBreak(";") : ";"];
        }
      ...
      case "media-url":
        ...
        false, string_replace_all_default(
        /* isOptionalObject*/
        false, node.value, /^url\(\s+/gi, "url("), /\s+\)$/g, ")"), options2);
      ...
      case "selector-attribute":
        return ["[", node.namespace ? [node.namespace === true ? "" : node.namespace.trim(), "|"] : "", node.attribute.trim(), (_node$operator = node.operator) != null ? _node$operator : "", node.value ? quoteAttributeValue(adjustStrings(node.value.trim(), options2), options2) : "", node.insensitive ? " i" : "", "]"];
  ...
  var printer_postcss_default = printer; // src/language-css/parser-postcss.js
  ...
  var import_scss_parse = __toESM(require_scss_parse(), 1); // src/common/parser-create-error.js


  function createError(message, options2) {
    const error = new SyntaxError(message + " (" + options2.loc.start.line + ":" + options2.loc.start.column + ")");
    return Object.assign(error, options2);
  }

  var parser_create_error_default = createError; // src/language-css/utils/is-scss-nested-property-node.js
  ...
  var is_scss_nested_property_node_default = isSCSSNestedPropertyNode; // src/language-css/utils/is-module-rule-name.js
  ...
  var is_module_rule_name_default = isModuleRuleName; // src/language-css/parse/parse-value.js

  var import_parser = __toESM(require_parser2(), 1); // src/language-css/utils/get-value-root.js
  ...
  var get_value_root_default = getValueRoot; // src/language-css/utils/get-function-arguments-text.js
  ...
  var get_function_arguments_text_default = getFunctionArgumentsText; // src/language-css/utils/has-scss-interpolation.js
  ...
  var has_scss_interpolation_default = hasSCSSInterpolation; // src/language-css/utils/has-string-or-function.js

  function hasStringOrFunction(groupList) {
    return groupList.some(group2 => group2.type === "string" || group2.type === "func" && // workaround false-positive func
    !group2.value.endsWith("\\"));
  }

  var has_string_or_function_default = hasStringOrFunction; // src/language-css/utils/is-scss-variable.js

  function isSCSSVariable(node, options2) {
    return Boolean(options2.parser === "scss" && (node == null ? void 0 : node.type) === "word" && node.value.startsWith("$"));
  }

  var is_scss_variable_default = isSCSSVariable; // src/language-css/parse/parse-selector.js

  var import_processor = __toESM(require_processor2(), 1); // src/language-css/parse/utils.js
  ...
  var parse_selector_default = parseSelector; // src/language-css/parse/parse-value.js
  ...
  function parseValueNode(valueNode, options2) {
    ...
    for (let i = 0; i < nodes.length; ++i) {
      ...
      if (node.type === "func" && node.value === "url") {
        ...
        const groups = (_ref2 = (_a = node.group) == null ? void 0 : _a.groups) != null ? _ref2 : [];
        let groupList = [];
  ...
  var parse_value_default = parseValue; // src/language-css/parse/parse-media-query.js
  ...
  var parse_media_query_default = parseMediaQuery; // src/language-css/parser-postcss.js
  ...
  function parseNestedCSS(node, options2) {
    ...
    if (node && typeof node === "object") {
      ...
      (_node$raws = node.raws) != null ? _node$raws : node.raws = {};
      ...
      if (typeof node.selector === "string") {
        ...
        selector = node.raws.selector ? (_node$raws$selector$s = node.raws.selector.scss) != null ? _node$raws$selector$s : node.raws.selector.raw : node.selector;
      ...
      if (typeof node.value === "string") {
        ...
        value = node.raws.value ? (_node$raws$value$scss = node.raws.value.scss) != null ? _node$raws$value$scss : node.raws.value.raw : node.value;
        value = value.trim();
      ...
      if (typeof node.params === "string") {
        ...
        params = node.raws.params ? (_node$raws$params$scs = node.raws.params.scss) != null ? _node$raws$params$scs : node.raws.params.raw : node.params;
  ...
  function parseLess(text, options2 = {}) {
    return parseWithParser( // Workaround for https://github.com/shellscape/postcss-less/issues/145
    // See comments for `replaceQuotesInInlineComments` in `loc.js`.
    text2 => import_postcss_less.default.parse(replaceQuotesInInlineComments(text2)), text, options2);
  }
  ...
  var css = { ...postCssParser,
    parse: parseCss
  };
  var less = { ...postCssParser,
    parse: parseLess
  };
  var scss = { ...postCssParser,
    parse: parseScss
  ...
  var options_default = options; // src/language-css/index.js
